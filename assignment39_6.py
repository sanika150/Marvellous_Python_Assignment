...
model = DecisionTreeClassifier(
    criterion="gini",
    max_depth= None, #tunning tunned value
    random_state= 42
)
...
#---------------------------------------------------------
'''For this data when we change the max depth value accuracy not change because we have very 
small dataset of 30 records'''